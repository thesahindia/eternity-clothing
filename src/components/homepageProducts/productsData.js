const PRODUCTS_DATA = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        sizes: [28, 29, 30, 32],
        rating: 5,
        img: [{ url: "jeans/o.1.jpg" }, { url: "jeans/o.2.jpg" }, { url: "jeans/o.3.jpg" }],
      },
     ...
     
      {
        ...
        sizes: [28, 29, 30, 32],
        rating: 4.5,
        img: [{ url: "jeans/e.1.jpg" }, { url: "jeans/e.2.jpg" }, { url: "jeans/e.3.jpg" }],
      },
  ...
  },
  {
    ...
    items: [
      ...
      sizes: [ "M", "L", "XL"],
      rating: 5,
      img: [{ url: "jackets/l.1.jpg" }, { url: "jackets/l.2.jpg" }, { url: "jackets/l.3.jpg" }],
    },
    {
      id: 8,
